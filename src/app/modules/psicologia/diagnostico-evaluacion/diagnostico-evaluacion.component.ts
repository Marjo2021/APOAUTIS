...
@Component({
  selector: 'app-diagnostico-evaluacion',
  templateUrl: './diagnostico-evaluacion.component.html',
  styleUrls: ['./diagnostico-evaluacion.component.css']
})
export class DiagnosticoEvaluacionComponent implements OnInit {
  ...
  editar(item: any) {
    ...
    this._dialog.open(DiagnosticoComponent, dialogConfig);
